...
## 🚀 What I’m focused on
- Building full-stack products with modern frontend + API stacks
- Designing observable data/ETL systems
- Applying ML and security thinking to real-world problems

## 🧩 Featured work
- **[Quotes Application](https://github.com/aryanmishal/quotes-application)** — Full-stack quote sharing app with auth, reactions, and daily quote delivery (FastAPI + MongoDB + Next.js)
